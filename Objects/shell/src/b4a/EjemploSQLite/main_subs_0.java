...
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("LogImpl","1196617",RemoteObject.concat(RemoteObject.createImmutable("Table creation failed:"),_table,RemoteObject.createImmutable(", "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 };
...
Debug.ShouldStop(2097152);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1655375",RemoteObject.concat(RemoteObject.createImmutable("ERROR al elminar tabla: "),parent.mostCurrent._tables_db.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))),RemoteObject.createImmutable(" ,"),parent.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 if (true) break;
if (true) break;
...
Debug.ShouldStop(2097152);
main.mostCurrent.__c.runVoidMethod ("LogImpl","1458762",RemoteObject.concat(RemoteObject.createImmutable("Insert into failedd:"),_table,RemoteObject.createImmutable(", "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 };
...
Debug.ShouldStop(8);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","1589848",RemoteObject.createImmutable("distintos dias"),0);
...
Debug.ShouldStop(8);
main.mostCurrent.__c.runVoidMethod ("LogImpl","1786442",RemoteObject.concat(RemoteObject.createImmutable("Update into failedd:"),_table,RemoteObject.createImmutable(", "),main.mostCurrent.__c.runMethod(false,"LastException",main.mostCurrent.activityBA).runMethod(true,"getMessage")),0);
 };
